<%@ Page Title="Giriş" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OkulProjesiWebForm.Pages.Account.Login" %>
            ...
            <div class="card card-success">
                ...
                <!-- Card Footer -->
                 <div class="card-footer">
                      ...
                      <a runat="server" href="~/Pages/Account/Register" class="btn btn-outline-info float-right">Kayıt ol</a>
                 </div>
           </div>
        </div>
